...
ptw_scan = ReadMCC(file_dir + r'\X10 OPEN 10X10 PDDCRIN WAT 210220.mcc')
ptw_scan.process_data()
# gd = ReadGoldenData(r'D:\MEGA\VARIAN Golden Beam data', 'Truebeam', '6MV')
ref = ReadGoldenData(r'X:\Physics\RPU\RayStation\Commissioning\BeamData\VARIAN Golden Beam data', 'Truebeam', '10MV')
